...
def send_to_powerbi_endpoint():
    ...
    if current_date != last_date or last_date is None:
        ...
        last_volume = None  # Reset last volume to None on date change
...
def send_to_powerbi(data_to_send):
    api_url = "https://api.powerbi.com/beta/fbf770ac-3ae0-464d-9457-cb04ad0b06f5/datasets/0d7f8fc6-642d-47fd-8354-ca3dcd3906f6/rows?experience=power-bi&key=JYtbm2oiF0MA821mdyMkRDsHJMFDYNyH7dunBjvCGLI2JVBdoreE%2FmWniH1D3gS3nNEao2uz%2BmjsXHuZM3y9Dw%3D%3D"
