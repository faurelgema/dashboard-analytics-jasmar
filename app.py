...
def get_data_from_dashboard_view_lalin_daily(current_date):
    try:
        ...
        cursor.execute("SELECT * FROM a_union.dashboard_view_lalin_daily WHERE tanggal = %s", (current_date,))
...
def send_to_powerbi(data_to_send):
    api_url = "https://api.powerbi.com/beta/fbf770ac-3ae0-464d-9457-cb04ad0b06f5/datasets/38a0b5dd-a5d5-4601-8079-eacb515cf533/rows?experience=power-bi&key=G2n2T%2BMWbN2diALVHqbPnlNxD0SUMOPuPusBgu3J1ZE2yPfrcRHNnjiiFG0zSOlrQSh7Umu3wU6tGXj0ZnqGbA%3D%3D"
