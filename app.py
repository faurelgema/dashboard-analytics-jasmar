...
def send_to_powerbi(data_to_send):
    ...
    api_url = "https://api.powerbi.com/beta/fbf770ac-3ae0-464d-9457-cb04ad0b06f5/datasets/792cbb9e-acbb-4ea3-96cd-b8d1b7b1bbd1/rows?experience=power-bi&key=coBydcRmvRzR2h3Oyv3uT4z%2BOGfS3DJukkQM1KWZpyjmqOZhZzVKUBKFFavwR1gQJ5zFm%2Fj%2FKptRZKzSgiYYtw%3D%3D"
...
def send_to_powerbi_endpoint():
    ...
    if isinstance(dashboard_view_lalin_daily_data, list) and dashboard_view_lalin_daily_data:
        ...
        if last_value is not None:  # Jika ada nilai sebelumnya
            difference = new_value - float(last_value)  # Hitung selisih dengan nilai terakhir
